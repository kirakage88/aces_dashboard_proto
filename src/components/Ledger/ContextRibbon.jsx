    ...
    <div className="bg-[#550000] text-white px-3 md:px-8 py-2 text-[10px] flex flex-wrap items-center justify-between gap-3 border-b border-[#800000]">
      <div className="flex items-center gap-3 md:gap-6 flex-wrap">
        <div className="flex items-center gap-2">
          <Calendar size={12} className="text-[#efbf04]" />
          <span className="font-bold tracking-tight uppercase flex items-center gap-2 md:gap-3">
            ...
            <div className="flex items-center gap-1 bg-[#800000]/50 px-2 py-0.5 rounded-lg border border-[#800000]/50 shadow-inner">
              <button onClick={onPrevMonth} className="hover:text-[#efbf04] transition-colors p-0.5">
                <ChevronLeft size={14} />
              </button>
              <span className="min-w-[70px] text-center text-[#efbf04] font-black">{summary.month}</span>
              <button onClick={onNextMonth} className="hover:text-[#efbf04] transition-colors p-0.5">
        ...
        <div className="flex items-center gap-2">
          <BookOpen size={12} className="text-[#efbf04]" />
